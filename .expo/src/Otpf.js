    ...
    return(
     <Backg>
        ...
        <View style={{backgroundColor:"white", height:'100%',borderTopLeftRadius:130,paddingTop:100,alignItems:'center'}}>
            <Text style={{fontSize:40,color:darkGreen,fontWeight:"bold"}}>Enter OTP</Text>
            <Text style={{color:"grey",fontSize:19,fontWeight:"bold",marginBottom:20}}></Text>
          ...
          <Btn textColor='white' bgColor={darkGreen} btnLabel="Reset password" Press={()=>alert("Reset password")}/>
